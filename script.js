...
function anim() {
  ...
  // Redirect only once, when all letters are done
  if (done && !window._redirected) {
    window._redirected = true; // Prevent multiple redirects
    setTimeout(redirectToCake, 1000); // Wait 1s before redirecting (optional)
  }
}
...
// Call this function when your animation is finished
